					    ...
					    <div class="row">
                           ...
                           <div class="border border-3 p-4 rounded">
							 <div class="mb-3">
								...
								<input type="text" name="title" class="form-control" id="inputProductTitle" value="{{ old('title')}}" placeholder="Enter post title">
							  ...
							  <div class="mb-3">
								...
								<textarea id="mytextarea" name="body" class="form-control" id="inputProductDescription" rows="3">{{old('body')}}</textarea>
                                @error('body')
                                    <p class="text-danger">{{$message}}</p>
                                @enderror
							  </div>
							  <div class="mb-3">
								...
								<input required id="thumbnail" type="file"  name="thumbnail" id="file">
                                @error('thumbnail')
                                    <p class="text-danger">{{$message}}</p>
                                @enderror
							  </div>
